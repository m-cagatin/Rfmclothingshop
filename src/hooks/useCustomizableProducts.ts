...
// Transform API response - Backend already returns camelCase
function transformApiProduct(apiProduct: any): CustomizableProduct {
  return {
    ...
    fitType: apiProduct.fitType || '',
    fitDescription: apiProduct.fitDescription || '',
    ...
    fabricComposition: apiProduct.fabricComposition || '',
    fabricWeight: apiProduct.fabricWeight || '',
    texture: apiProduct.texture || '',
    baseCost: apiProduct.baseCost || 0,
    retailPrice: apiProduct.retailPrice || 0,
    sizePricing: apiProduct.sizePricing || {},
    frontPrintCost: apiProduct.frontPrintCost || undefined,
    backPrintCost: apiProduct.backPrintCost || undefined,
    differentiationType: apiProduct.differentiationType || 'none',
    color: apiProduct.color || undefined,
    variant: apiProduct.variant || undefined,
    sizeAvailability: apiProduct.sizeAvailability || {},
    printMethod: apiProduct.printMethod || '',
    printAreas: apiProduct.printAreas || [],
    designRequirements: apiProduct.designRequirements || '',
    turnaroundTime: apiProduct.turnaroundTime || '',
